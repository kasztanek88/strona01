...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('JkOVm91KNP', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('zW906VMwIU', 0, '62uiVvITYqAsAAFUBQ01jw', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $a->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wjftorkH0m', 0, '62uiVvITYqAsAAFUBQ01jw', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $a->addEventSubscriber($this->get('app.doctrine.hash_password_listener'));
        $a->addEventListener(array(0 => 'loadClassMetadata'), $this->get('doctrine.orm.default_listeners.attach_entity_listeners'));
        $a->addEventListener(array(0 => 'prePersist', 1 => 'preUpdate', 2 => 'postLoad'), $this->get('app.eventlistener.file_upload_listener'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'strona01', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    public function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['doctrine.orm.default_entity_manager'] = DoctrineORMEntityManager_0000000061f7a6fe000000006f4a164572d3147ccc78175fc8690f644619c0dc::staticProxyConstructor(
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_09fc6fb449dd6c01beb11a11f4fdf17299b47fe9353b7d29169033c46fa7a595');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $n = new \Symfony\Component\Security\Http\HttpUtils($f, $f);
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($m, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $c), 'main', $a, $d, $e), 2 => $o, 3 => new \Symfony\Component\Security\Guard\Firewall\GuardAuthenticationListener($this->get('security.authentication.guard_handler'), $g, 'main', array(0 => $h), $a), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '58467a4e467b48.92609281', $a, $g), 5 => new \Symfony\Component\Security\Http\Firewall\SwitchUserListener($b, $c, $this->get('security.user_checker.main'), 'main', $i, $a, '_switch_user', 'ROLE_ALLOWED_TO_SWITCH', $d), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $i, $m, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $e, $n, 'main', $h, NULL, NULL, $a, false));
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yTH27l+8Bm', 0, '62uiVvITYqAsAAFUBQ01jw', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'validator.mapping.cache.prefix' => 'validator_4ea530b7ebcd8605bfa061dbbe39eef02aad9bb767f9a4bebb6ad72285d39a4b',
...
class DoctrineORMEntityManager_0000000061f7a6fe000000006f4a164572d3147ccc78175fc8690f644619c0dc extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder58467a507da84150763965 = null;
    private $initializer58467a507da84054942648 = null;
    private static $publicProperties58467a507da84124205059 = array(
        
    );
    public function getConnection()
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'getConnection', array(), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->getConnection();
    }
    public function getMetadataFactory()
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'getMetadataFactory', array(), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->getMetadataFactory();
    }
    public function getExpressionBuilder()
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'getExpressionBuilder', array(), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->getExpressionBuilder();
    }
    public function beginTransaction()
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'beginTransaction', array(), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->beginTransaction();
    }
    public function getCache()
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'getCache', array(), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->getCache();
    }
    public function transactional($func)
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'transactional', array('func' => $func), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->transactional($func);
    }
    public function commit()
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'commit', array(), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->commit();
    }
    public function rollback()
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'rollback', array(), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->rollback();
    }
    public function getClassMetadata($className)
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'getClassMetadata', array('className' => $className), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->getClassMetadata($className);
    }
    public function createQuery($dql = '')
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'createQuery', array('dql' => $dql), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->createQuery($dql);
    }
    public function createNamedQuery($name)
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'createNamedQuery', array('name' => $name), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->createNamedQuery($name);
    }
    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->createNativeQuery($sql, $rsm);
    }
    public function createNamedNativeQuery($name)
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->createNamedNativeQuery($name);
    }
    public function createQueryBuilder()
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'createQueryBuilder', array(), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->createQueryBuilder();
    }
    public function flush($entity = null)
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'flush', array('entity' => $entity), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->flush($entity);
    }
    public function find($entityName, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'find', array('entityName' => $entityName, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->find($entityName, $id, $lockMode, $lockVersion);
    }
    public function getReference($entityName, $id)
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->getReference($entityName, $id);
    }
    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->getPartialReference($entityName, $identifier);
    }
    public function clear($entityName = null)
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'clear', array('entityName' => $entityName), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->clear($entityName);
    }
    public function close()
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'close', array(), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->close();
    }
    public function persist($entity)
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'persist', array('entity' => $entity), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->persist($entity);
    }
    public function remove($entity)
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'remove', array('entity' => $entity), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->remove($entity);
    }
    public function refresh($entity)
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'refresh', array('entity' => $entity), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->refresh($entity);
    }
    public function detach($entity)
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'detach', array('entity' => $entity), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->detach($entity);
    }
    public function merge($entity)
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'merge', array('entity' => $entity), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->merge($entity);
    }
    public function copy($entity, $deep = false)
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->copy($entity, $deep);
    }
    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->lock($entity, $lockMode, $lockVersion);
    }
    public function getRepository($entityName)
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'getRepository', array('entityName' => $entityName), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->getRepository($entityName);
    }
    public function contains($entity)
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'contains', array('entity' => $entity), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->contains($entity);
    }
    public function getEventManager()
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'getEventManager', array(), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->getEventManager();
    }
    public function getConfiguration()
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'getConfiguration', array(), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->getConfiguration();
    }
    public function isOpen()
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'isOpen', array(), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->isOpen();
    }
    public function getUnitOfWork()
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'getUnitOfWork', array(), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->getUnitOfWork();
    }
    public function getHydrator($hydrationMode)
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->getHydrator($hydrationMode);
    }
    public function newHydrator($hydrationMode)
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->newHydrator($hydrationMode);
    }
    public function getProxyFactory()
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'getProxyFactory', array(), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->getProxyFactory();
    }
    public function initializeObject($obj)
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'initializeObject', array('obj' => $obj), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->initializeObject($obj);
    }
    public function getFilters()
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'getFilters', array(), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->getFilters();
    }
    public function isFiltersStateClean()
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'isFiltersStateClean', array(), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->isFiltersStateClean();
    }
    public function hasFilters()
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'hasFilters', array(), $this->initializer58467a507da84054942648);
        return $this->valueHolder58467a507da84150763965->hasFilters();
    }
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer58467a507da84054942648 = $initializer;
        return $instance;
    }
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        static $reflection;
        if (! $this->valueHolder58467a507da84150763965) {
            $reflection = $reflection ?: new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder58467a507da84150763965 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        }, $this, 'Doctrine\\ORM\\EntityManager')->__invoke($this);
        }
        $this->valueHolder58467a507da84150763965->__construct($conn, $config, $eventManager);
    }
    public function & __get($name)
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, '__get', array('name' => $name), $this->initializer58467a507da84054942648);
        if (isset(self::$publicProperties58467a507da84124205059[$name])) {
            return $this->valueHolder58467a507da84150763965->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder58467a507da84150763965;
    ...
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer58467a507da84054942648);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder58467a507da84150763965;
    ...
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, '__isset', array('name' => $name), $this->initializer58467a507da84054942648);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder58467a507da84150763965;
    ...
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, '__unset', array('name' => $name), $this->initializer58467a507da84054942648);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder58467a507da84150763965;
    ...
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, '__clone', array(), $this->initializer58467a507da84054942648);
        $this->valueHolder58467a507da84150763965 = clone $this->valueHolder58467a507da84150763965;
    }
    public function __sleep()
    {
        $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, '__sleep', array(), $this->initializer58467a507da84054942648);
        return array('valueHolder58467a507da84150763965');
    }
    ...
    {
        $this->initializer58467a507da84054942648 = $initializer;
    }
    public function getProxyInitializer()
    {
        return $this->initializer58467a507da84054942648;
    }
    public function initializeProxy() : bool
    {
        return $this->initializer58467a507da84054942648 && $this->initializer58467a507da84054942648->__invoke($this->valueHolder58467a507da84150763965, $this, 'initializeProxy', array(), $this->initializer58467a507da84054942648);
    }
    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder58467a507da84150763965;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder58467a507da84150763965;
    }
}
